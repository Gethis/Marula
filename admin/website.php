	...
	<body data-instant-track data-instant>
		...
		<div id="change_website">
			...
			<?php
				...
				echo "<h2>Current Slides: (made smaller for viewing)</h2>";
				if($file_num_slide > 0){
					for($i = 1; $i < $file_num_slide; $i++){
						list($width, $height) = getimagesize("../img/slideshow_slide$i.png");
						if($width > 512 || $height > 512){
							echo "<img id='show_slide$i' class='slide_show' style='width: 512px; margin: 5px;' src='../img/slideshow_slide$i.png'/>";
						} else{
							echo "<img id='show_slide$i' class='slide_show' style='margin: 5px;' src='../img/slideshow_slide$i.png'/>";
						}
					}
				} else{
					echo "No slides yet.";
